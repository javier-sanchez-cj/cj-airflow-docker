...
: "${AIRFLOW__CORE__DAGS_FOLDER:="/home/airflow/cj-airflow-dags/airflow_dags/dags"}"
...
if [ -e "/home/airflow/cj-airflow-dags/requirements.txt" ]; then
    $(command -v pip) install --user -r /home/airflow/cj-airflow-dags/requirements.txt
fi
